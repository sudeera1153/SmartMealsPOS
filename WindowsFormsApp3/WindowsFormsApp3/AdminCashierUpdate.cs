...
namespace WindowsFormsApp3
{
    ...
    {
        SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=F:\C\Database\ss.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void guna2Button11_Click(object sender, EventArgs e)
        {
            ...
            {
                string uservalqry = "select * from cashier where username = '" + txt_up_cashuname.Text + "'";
                SqlDataAdapter unvaladapter = new SqlDataAdapter(uservalqry, connection);
                DataTable dtun = new DataTable();
                unvaladapter.Fill(dtun);
                if (dtun.Rows.Count == 0)
                {
